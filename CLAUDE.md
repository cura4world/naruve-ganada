...
**파일은 이미 들어 있다 (2026-08-19).** docs/audio/m/ 과 docs/audio/f/ 에
mp3 100개(문장 50 × 목소리 2)가 있고 docs/audio/index.json이 그 목록이다.
...
- ~~유료 TTS로 음성 생성~~ — 끝났다 (2026-08-19). 타입캐스트 라이트 플랜,
  문장 50 × 목소리 2 = 100개가 docs/audio/에 있다. **seed로 재현되지 않으므로
...
docs/audio/{m,f}/ 에 mp3 100개(7.9 MB),
...
서비스워커는 이 파일들을 프리캐시하지 않는다. 첫 방문에 7.9 MB를 받게 하지 않으려는 것이고,
